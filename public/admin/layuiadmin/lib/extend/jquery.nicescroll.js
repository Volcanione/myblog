;(function(jQuery) {
  ...
  var getBrowserDetection = function() {
    ...
    d.isie7mobile =
      !d.isie9mobile && d.isie7 && /iemobile/i.test(navigator.userAgent)
  ...
  var NiceScrollClass = function(myopt, me) {
      ...
      if (!self.ispage || (!cap.cantouch && !cap.isieold && !cap.isie9mobile)) {
        ...
        if (cap.isie9mobile) {
          ...
          if (self.opt.enablemousewheel) {
            if (!self.isiframe)
              self.bind(
                cap.isie && self.ispage ? document : self.win,
                'mousewheel',
                self.onmousewheel
              )
    ...
    this.isScrollable = function(e) {
      ...
      while (dom && dom.nodeType == 1 && !/BODY|HTML/.test(dom.nodeName)) {
        var dd = $(dom)
        var ov =
          dd.css('overflowY') || dd.css('overflowX') || dd.css('overflow') || ''
